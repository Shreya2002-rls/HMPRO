...
<body style="background-image: url(images/phpbg.png);">
	...
	?>
				...
				<h4>UserId : <?php echo "1"; ?></h4>
				<h4>Table Name : <?php echo "After Dark"; ?></h4>
				<h4>Guest : <?php echo "4"; ?></h4>
				<h4>Dine Date : <?php echo "2020-04-08"; ?></h4>
				<h4>Dine Time : <?php echo "17:41:00"; ?></h4>
				<h4>Special Requests : <?php echo "no"; ?></h4>
				<br/><br/>
				</center>
	<?php
					}
